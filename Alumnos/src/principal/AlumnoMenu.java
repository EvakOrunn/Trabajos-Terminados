...
public class AlumnoMenu {
    ...
    public static void listarPorDestino() {
        ...
        do {
            ...
            codigoCurso = Consola.readInt();
        } while (DestinosMenu.obtener(codigoCurso) == null); // Repetir hasta que se encuentre destino
        ...
        while (!m2.eof()) {
            ...
            if (reg.getActivo()) { // Pregunto si esta activo
                Alumno v = (Alumno) reg.getDatos(); // Obtengo los datos
                if (v.getCodigoCurso() == codigoCurso) { // Pregunto si es hacia el destino que quiero
    ...
    public static Registro leer() {
        ...
        int codigo;
        do {
            System.out.print("Codigo Alumno--> ");
            codigo = Consola.readInt();
            if (obtener(codigo) != null) {
                System.out.println("Codigo ya existente.");
                codigo = -1;
            }
        } while (codigo < 0 || codigo > alumno.tamArchivo());
        alumno.setDNI(codigo);
        alumno.cargarDatos();
        Registro reg = new Registro(alumno, alumno.getDNI()); // Aqui es donde se indica que la clave principal es "Codigo"
        return reg;
    }
    ...
    public static void modificar() {
        ...
        Alumno alu = (Alumno) reg.getDatos();
        alu.cargarDatos();
        reg.setDatos(alu);
    ...
    public static void menu() {
        ...
        do {
            ...
            System.out.println("- 3. Modificacion de Alumnos     -");
