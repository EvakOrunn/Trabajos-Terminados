...
public class CursoMenu {
    ...
    public static void listar() {
        int contador = 0;
        int caracteres = 41; // Caracteres de la tabla. Cambiar para ajustar ancho de lineas
    ...
    public static Registro leer() {
        ...
        } while (codigo < 0 || codigo > curso.tamArchivo());
        curso.setCodigoCurso(codigo);
        curso.cargarDatos();
        Registro reg = new Registro(curso, curso.getCodigoCurso()); // Aqui es donde se indica que la clave principal es "Codigo"
        return reg;
    }
    ...
    public static void modificar() {
        ...
        Curso curso = (Curso) reg.getDatos();
        curso.cargarDatos();
        reg.setDatos(curso);
    ...
    public static void inicializarArchivo() {
        try {
            m2 = new Archivo("Curso.dat", new Curso());
            if (!m2.getFd().exists()) {
    ...
    public static void menu() {
        ...
        do {
            ...
            System.out.println("- 3. Modificacion de Curso         -");
            System.out.println("- 4. Listar Cursos activos         -");
